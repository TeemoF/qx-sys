			...
			columns : [ [
					{
						...
						align : 'center',
						width : 100,
						formatter : function(value, permission, index) {
					...
					},
					{
						...
						width : 80,
						formatter : function(value, permission, index) {
							return '<button type="button" onclick="detail('+index+')" class="btn btn-link">'+permission.name+'</button>';
						}
					},
					{
						field : 'url',
...
<body>
	...
	<div id="toolbar" style="border: none;">
		...
		<span>
			...
			<button type="button" name="addBtn" class="btn btn-primary"> <span class="glyphicon glyphicon-plus"></span>增加权限</button>
		</span>
	</div>
